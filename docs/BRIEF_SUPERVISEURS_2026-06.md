...
| **Récupérer les données Bio-ORACLE** selon scénario | partiel  | Variables marines actuelles **et futures** (scénarios climatiques SSP), sélection par zone et profondeur |
