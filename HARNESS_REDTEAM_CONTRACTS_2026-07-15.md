...
**Statut :** 6 dettes résolues (dont l'allowlist skills fail-closed en étape 8 et le budget fixe en étape 6); 1 contrat reste versionné avec `xfail(strict=True)` (confirmation exécutable étape 7); 1 dette comportementale 4A.1 nouvellement observée reste à transformer en contrat rouge.
...
- `tests/harness_redteam/test_code_isolation_contracts.py`
