...
Apply this skill only when the current user request explicitly names OGSL and
the active session does not forbid OGSL. Do not load or apply this skill for
