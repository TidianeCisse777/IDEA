...
- For visual intent, call `load_skill("graph_planner")`, then `load_skill("graph_writer")`; do not stop after planning. The very next execution call after `load_skill("graph_writer")` must be `run_graph`."""
