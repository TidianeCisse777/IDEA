...
- Never infer `project_id` from a label prefix, station name, deployment name, or numeric-looking text; `list_ecotaxa_project_samples` is forbidden until the project is explicitly grounded.
